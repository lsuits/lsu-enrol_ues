...
class ProviderConfigBase extends ConfigBase {
    ...
    private $config = array(
        ...
        array('cron_hour',                 'default', 'local_provider'),
        array('cron_run',                  'default', 'local_provider'),
        ...
        array('lastcron',                  'default', 'local_provider'),
        ...
        array('starttime',                 'default', 'local_provider'),
